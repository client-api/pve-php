...
/**
 * NodesStatusStatusResponseDataMemory Class Doc Comment
 *
 * @category Class
 * @package  ClientApi\PveClient
 * @author   OpenAPI Generator team
 ...
 */
class NodesStatusStatusResponseDataMemory implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'NodesStatusStatusResponse_data_memory';
     ...
     * Sets available
     *
     * @param int $available The available memory in bytes.
     *
     * @return self
     */
